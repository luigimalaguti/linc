...
Questo file contiene riferimenti a risorse utili per il progetto. Le risorse sono organizzate in sezioni per facilitare la consultazione.

## GitHub

- [log.c](https://github.com/rxi/log.c)
- [clog](https://github.com/0xA1M/clog)
- [spdlog](https://github.com/gabime/spdlog)
- [quill](https://github.com/odygrd/quill)
- [helloc](https://github.com/miguno/helloc)
- [C-project-template](https://github.com/peterdn/C-project-template)

## YouTube

- [Canale di Esadecimale](https://www.youtube.com/@esadecimale)
...
- [Creating a robust logging system in C](https://dev.to/scovl/creating-a-robust-logging-system-in-c-2fg6)
...
- [Crafting a Clean, Maintainable, and Understandable Makefile for a C Project.](https://www.lucavall.in/blog/crafting-clean-maintainable-understandable-makefile-for-c-project)
